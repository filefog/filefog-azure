...
Client.prototype.createFile = function (fileName, parentIdentifier, content_buffer, options) {
    ...
    return this._getClient()
        .then(function (client) {
            ...
            client.createBlockBlobFromText(this.credentials.storage_container
                , path
                , content_buffer
...
Client.prototype.deleteFile = function (identifier) {
    return this._getClient()
        .then(function(client){
            var deferred = q.defer();
            client.deleteBlob(this.credentials.storage_container, identifier, function (err, response) {
...
Client.prototype.downloadFile = function (identifier,options) {
    ...
    return this._getClient().then(function (client) {
        ...
        client.getBlobToStream(this.credentials.storage_container, identifier, memstream, function (err, response) {
            if (err) return deferred.reject(err);
...
Client.prototype.getFileInformation = function (identifier,options) {
    ...
    return this._getClient()
        .then(function (client) {
            var deferred = q.defer();
            client.getBlobProperties(this.credentials.storage_container, identifier, options, function (err,  response) {
                if (err) return deferred.reject(err);
                return deferred.resolve(response);
            });
            return deferred.promise;
...
Client.prototype.updateFileInformation = function (current_identifier,fileName, parentIdentifier, options) {
    ...
    return this._getClient()
        .then(function (client) {
            var deferred = q.defer();
            client.startCopyBlob(client.getUrl(this.credentials.storage_container, current_identifier),
                this.credentials.storage_container,
...
Client.prototype.createFolder = function (folderName, parentIdentifier, options) {
    //throw {name : "NotImplementedError", message : "creating folders not available with Azure"};
    //passthrough method. cannot create folders in azure
    return q({identifier:createPath(folderName, parentIdentifier)})
};

Client.prototype.deleteFolder = function(){
...
Client.prototype.retrieveFolderItems = function (identifier,options) {
    ...
    return this._getClient()
        .then(function (client) {
            var deferred = q.defer();
            client.listBlobDirectoriesSegmentedWithPrefix(this.credentials.storage_container, path, pagination, options, function (err, result, response) {
                if (err) return deferred.reject(err);
                return deferred.resolve(response);
            });
            return deferred.promise;
...
Client.prototype._getClient = function() {
    ...
    blobService.createContainerIfNotExists(this.credentials.storage_container
